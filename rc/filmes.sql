...
--
-- Host: 127.0.0.1
-- Generation Time: 08-Jan-2021 às 13:23
...
CREATE TABLE `realizadores` (
  `id_realizadores` int(11) NOT NULL,
...
ALTER TABLE `realizadores`
  ADD PRIMARY KEY (`id_realizadores`);
...
--
ALTER TABLE `realizadores`
  MODIFY `id_realizadores` int(11) NOT NULL AUTO_INCREMENT;
